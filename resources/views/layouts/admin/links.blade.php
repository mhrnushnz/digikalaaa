...
<link href="/admin/assets/css/loader.css" rel="stylesheet" type="text/css" />    {{--  آدرس دهی با / اول مسیر مطلق حساب میشه که استایل رو همیشه درست لود میکنه و همیشه اجرا میشه استایل --}}
{{--  آدرس دهی بدون/اول مسیر نسبی حساب میشه که گاهی اوقات استایل رو درست لود نمیکنه  --}}
