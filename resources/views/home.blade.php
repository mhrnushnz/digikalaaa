        ...
        <div class="swiper myStorySwiper px-0">
            <div class="swiper-wrapper">
                ...
                <div
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#exampleModal">
                    <a href="#"><img width="80" src="/client/client/assets/story/takhfif.jpeg" /> </a>
                    <p class="text-center my-2 fw-medium fs-7">تخفیف ویژه</p>
                </div>
                <div
                    class="swiper-slide d-flex flex-column justify-content-center"
...
<div class="container rounded-3 mt-4 d-block d-md-none">
    <img src="/client/client/assets/slider/supermarket.png" alt="banner" class="w-100" />
</div>
    ...
    <div class="productItems overflow-hidden d-flex flex-column flex-lg-row align-items-center bg-danger">
        ...
        <div class="d-flex align-items-center justify-content-between gap-3 gap-lg-0 flex-lg-column Suggestion">
            <div
                ...
                <img width="80" src="/client/assets/productSlider/Amazings (1).svg" class="d-none d-lg-block" alt="slide-img" />
...
<section class="container">
    <div class="row">
        <div class="col-12 col-lg-6">
            <img class="w-100 h-100 rounded-4 object-fit-cover" src="/client/assets/imagePackage/easyLife.webp" alt="ads" />
        </div>
        <div class="col-12 col-lg-6">
            <img class="w-100 h-100 rounded-4 object-fit-cover" src="/client/assets/imagePackage//molfix.jpg" alt="ads" />
        </div>
    </div>
</section>
...
<footer class="mt-5 border-top pt-5">
    <div class="container-fluid px-lg-5">
        ...
        <div class="d-none d-lg-flex row mt-5">
            <div class="col-12 col-lg-6">
                ...
                <p class="text-wrap text-black-50">
                    اینترنتی مطمئن، نیازمند فروشگاهی است که بتواند کالاهایی متنوع، باکیفیت و دارای قیمت مناسب را در مدت زمانی
        ...
        <p class="fw-light my-lg-5 copyright text-center text-secondary">
            برای استفاده از مطالب دیجی‌کالا، داشتن «هدف غیرتجاری» و ذکر «منبع» کافیست. تمام حقوق اين وب‌سايت نیز برای شرکت
